...
**Dernière mise à jour&#160;:** 13 septembre 2026. Cette politique couvre la
bêta fermée.
...
sur votre téléphone avant de le quitter, avec des clés que nous n'avons jamais.
Nous détenons les fichiers chiffrés, la liste de vos relations, et la
comptabilité nécessaire pour livrer des choses entre vous. Nous ne scannons,
...
clés qui n'existent que sur votre téléphone et sur ceux des gens avec qui vous
partagez&#160;:
...
- pour chaque publication&#160;: qui l'a faite, quand, à qui elle a été
  ...
  chiffrés, et si chaque destinataire l'a regardée&#160;;
...
- le texte de tout signalement que vous déposez, parce qu'un signalement est un
  message pour nous et que nous devons pouvoir le lire&#160;;
...
- les jetons d'envoi des téléphones sur lesquels vous vous êtes connecté&#160;;
...
que cette page dit déjà que nous détenons&#160;: les fichiers chiffrés, que
nous ne pouvons pas ouvrir, et les métadonnées. Il n'existe nulle part une clé à
vous que quiconque pourrait nous soutirer, ce qui est le but de tout
l'arrangement et non un heureux hasard.

Nous gardons ce qui précède aussi longtemps que votre compte existe,
puis&#160;:

- quand vous supprimez votre compte, les clés partent aussitôt et les fichiers
  chiffrés quittent le stockage huit jours plus tard&#160;;
...
- les comptes que votre téléphone envoie sont ajoutés à un total à l'arrivée et
  ...
  garder&#160;;
- les codes de connexion à usage unique et la trace d'une recherche sont
  balayés dès qu'ils ne peuvent plus changer aucune décision, c'est-à-dire la
  fenêtre sur laquelle chacun est limité&#160;;
...
détiendrait, c'est du chiffré et les métadonnées que cette page énumère.
...
Ce que nous gardons ensuite est la trace qu'un compte portant cet identifiant a
existé, les blocages que vous avez posés ou qui ont été posés contre vous, et
les signalements que vous avez déposés – sans votre nom, votre adresse ni votre
clé sur aucun d'eux.
...
si vous les voulez. Nous ne pouvons pas envoyer de photos lisibles, parce que
