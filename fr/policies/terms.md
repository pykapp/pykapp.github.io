...
permalink: /fr/conditions/
---

> **Cette page est la version française.** Elle et la [version
> anglaise](/terms/) disent la même chose&#160;; si elles diffèrent, c'est une
...
Ces conditions sont publiées en anglais et en français, et les deux sont censées
dire la même chose. **Si vous êtes un consommateur au Québec, c'est la version
française qui vous lie**, et c'est la version vers laquelle l'application
renvoie quand elle est en français. Nous ne vous demandons pas d'accepter la
version anglaise à la place. Partout ailleurs, c'est la version anglaise qui
lie. Si les deux diffèrent un jour, c'est une erreur de notre part et non un
choix, et nous la corrigerons.
...
avez déjà en un compte payant sans vous prévenir d'abord et sans vous laisser
le choix de partir avec vos données. Les conditions d'une formule payante
seront écrites quand il y en aura une&#160;; il ne sert à rien d'accepter
aujourd'hui une chose dont personne n'a fixé le prix.

## Ce que vous acceptez

- Vous ne publierez que des photos que vous avez le droit de partager, et
  seulement à des gens qui voudraient les voir.
...
Tout ce que vous publiez est à vous. Nous ne revendiquons aucune licence dessus
au-delà de ce qu'il faut pour stocker le fichier chiffré et le livrer aux gens
que vous avez choisis, et cette licence s'éteint avec le contenu. Nous ne
pouvons rien en lire, donc nous ne pourrions pas nous en servir autrement même
si nous le voulions.
...
Nous pouvons modifier ces conditions. Si un changement vous concerne – ce que
vous acceptez, ce que cela coûte, ou ce que nous pouvons faire de votre compte
– nous le dirons dans l'application et mettrons la date en haut de cette page
...
Gardez votre phrase de récupération en lieu sûr. C'est le seul moyen de
remettre votre compte sur un nouveau téléphone, et il n'y a pas de
réinitialisation&#160;: si elle est perdue en même temps que vos téléphones,
vos photos sont perdues et nous ne pouvons pas les récupérer.

Ce que vous partagez avec quelqu'un, cette personne peut le garder, comme avec
n'importe quelle autre façon d'envoyer une photo.
...
**Dans la mesure où la loi le permet, nous ne sommes pas responsables des
photos perdues, de l'accès perdu, ni de ce que quiconque fait de ce que vous
...
notre responsabilité en cas de fraude, de faute lourde ou intentionnelle de
notre part, ou de décès ou de dommage corporel que nous aurions causé**, et
rien ici ne retire un droit auquel il est impossible de renoncer et que vous
...
Vous pouvez supprimer votre compte à tout moment depuis les paramètres, ou
depuis [cette page](/fr/supprimer-votre-compte/) si vous n'avez plus
l'application. La [politique de
confidentialité](/fr/politique-de-confidentialite/) dit exactement ce que cela
détruit et quand.

Nous pouvons suspendre ou supprimer un compte qui enfreint les règles
ci-dessus, comme le décrit la politique de modération. Si nous supprimons votre
...
êtes un consommateur au Québec, vous pouvez agir en justice au Québec**, et le
droit québécois rend nulle, et pas seulement peu attrayante, une clause d'un
contrat comme celui-ci qui vous obligerait à aller ailleurs. Il en va de même
partout où le droit de la consommation le prévoit. Là où votre propre droit et
cette clause divergent, c'est votre droit qui l'emporte.

## Le reste

Si une partie de ces conditions est inapplicable, le reste demeure. Le fait de
